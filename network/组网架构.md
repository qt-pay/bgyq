...
**两台出口交换机，根据运营商分配多个公网地址，实现多路径备份。**

![](https://image-1300760561.cos.ap-beijing.myqcloud.com/bgyq-blog/net-arc-global.jpg)

*  业务区核心交换机上连一组交换机(IRF)作为border设备，border旁挂一组防火墙（IRF）作为租户南北向防火墙，为云内VPC业务配置安全策略；
